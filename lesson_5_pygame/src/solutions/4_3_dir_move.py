...
pygame.display.set_caption("Задание 4.3: Повороты и движение с направлением")
...
while running:
    ...
    # Движение В НАПРАВЛЕНИИ РОБОТА
    if keys[pygame.K_w]:
        # Двигаться вперед по направлению
    ...
    if keys[pygame.K_a]:
        # Двигаться влево (перпендикулярно направлению)
