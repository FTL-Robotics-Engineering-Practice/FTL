...
class Renderer:
    ...
    def __init__(self, screen, panel_width=0):
        ...
        Args:
            ...
            panel_width: ширина левой панели (0 = нет панели)
        """
        self.screen = screen
    ...
    def draw_info_panel(self, robot=None, mode_manager=None, grid=None):
        ...
        pygame.draw.rect(
            ...
            (0, 0, self.panel_width, self.screen.get_height())  # panel_width
        )
        ...
        if mode_manager is not None and mode_manager.is_map_mode():
            ...
            draw_text("K - сохранить")
            draw_text("L - загрузить")
        ...
        # TODO: Если в режиме робота - показываем данные робота
            ...
            draw_text(f"V угл: {robot.angular_velocity:.2f}")  # angular_velocity
            draw_text("")
