...
def main():
    ...
    # Автономный контроллер движения робота
    ...
    while running[0]:
        ...
        # TODO: Обновляем скорости робота
        # В режиме ROBOT используем автономный контроллер вместо клавиш
        if mode_manager.is_robot_mode():
            controller.update(dt=0.016, grid=grid)
