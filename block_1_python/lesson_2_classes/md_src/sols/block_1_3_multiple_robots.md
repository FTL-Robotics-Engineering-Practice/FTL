...
```python
# Блок 1.3: Три робота - почувствуй боль программиста! - РЕШЕНИЕ
# Задача: создать трех роботов, каждый рисует квадрат из своей стартовой позиции
...
print("Бета идет вправо:")
robot2_x = robot2_x + 1
print(f"  {robot2_name} в ({robot2_x}, {robot2_y})")
robot2_x = robot2_x + 1
print(f"  {robot2_name} в ({robot2_x}, {robot2_y})")
robot2_x = robot2_x + 1
print(f"  {robot2_name} в ({robot2_x}, {robot2_y})")
...
# Гамма идет вправо (4 шага)
print("Гамма идет вправо:")
for step in range(4):
    robot3_x = robot3_x + 1
    print(f"  {robot3_name} в ({robot3_x}, {robot3_y})")

# Гамма идет вверх (4 шага)
print("Гамма идет вверх:")
for step in range(4):
    robot3_y = robot3_y + 1
    print(f"  {robot3_name} в ({robot3_x}, {robot3_y})")

# Гамма идет влево (4 шага)
print("Гамма идет влево:")
for step in range(4):
    robot3_x = robot3_x - 1
    print(f"  {robot3_name} в ({robot3_x}, {robot3_y})")

# Гамма идет вниз (4 шага)
print("Гамма идет вниз:")
for step in range(4):
    robot3_y = robot3_y - 1
    print(f"  {robot3_name} в ({robot3_x}, {robot3_y})")
...
# Анализ проблемы
print(f"\n😵 АНАЛИЗ ПРОБЛЕМЫ:")
print(f"✅ Количество переменных: 9 (по 3 на робота)")
print(f"✅ Строк кода: ~80 строк")
print(f"✅ Копирование кода: 3 раза")
print(f"❌ Для 100 роботов: 300 переменных!")
print(f"❌ Для 100 роботов: ~2700 строк кода!")

print(f"\n💡 ВЫВОД: Нужен лучший способ!")
print(f"🔮 Следующий блок: Изучаем КЛАССЫ!")
```