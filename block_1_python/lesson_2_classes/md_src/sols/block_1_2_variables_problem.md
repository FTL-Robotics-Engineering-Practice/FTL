...
```python
# Блок 1.2: Создаем робота через переменные - РЕШЕНИЕ
# Задача: робот рисует квадрат 3x3
...
# Дополнительно: красивая статистика
print(f"\n📊 Статистика путешествия:")
print(f"   🤖 Имя: {robot_name}")
print(f"   📍 Стартовая позиция: (0, 0)")
print(f"   🏁 Финальная позиция: ({robot_x}, {robot_y})")
print(f"   📏 Размер квадрата: 3x3")
print(f"   👣 Общее количество шагов: 12")
```