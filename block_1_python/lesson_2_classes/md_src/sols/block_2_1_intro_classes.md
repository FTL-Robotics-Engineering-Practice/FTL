...
r = Robot("R2D2", 0, 0)
print("До изменения:", r.name, r.x, r.y)

r.name = "R2"
r.x = 5
r.y = 3
print("После изменения:", r.name, r.x, r.y)
...
print("r1:", r1.x, r1.y)  # ожидаем 2, 1
print("r2:", r2.x, r2.y)  # ожидаем -3, 4

# проверки
assert (r1.x, r1.y) == (2, 1)
assert (r2.x, r2.y) == (-3, 4)
```